...
All project documentation is organised here by area.
...
| File | Description |
|------|-------------|
| [README.md](./backend/api/README.md) | API project overview |
| [DATABASE_QUICK_REFERENCE.md](./backend/api/DATABASE_QUICK_REFERENCE.md) | PostgreSQL quick command reference |

### SignalR (`LiveSync.SignalR`)

| File | Description |
|------|-------------|
| [README_BACKEND.md](./backend/signalr/README_BACKEND.md) | SignalR service backend overview |
| [README_AUTH.md](./backend/signalr/README_AUTH.md) | Authentication setup for SignalR |
| [QUICK_REFERENCE.md](./backend/signalr/QUICK_REFERENCE.md) | Quick command/endpoint reference |
| [QUICK_START.md](./backend/signalr/QUICK_START.md) | Getting started with the SignalR service |
| [LAUNCH_CONFIGURATION.md](./backend/signalr/LAUNCH_CONFIGURATION.md) | Launch profiles and configuration |
| [MIGRATION_CHECKLIST.md](./backend/signalr/MIGRATION_CHECKLIST.md) | Checklist from the SignalR migration |
| [MIGRATION_SUMMARY.md](./backend/signalr/MIGRATION_SUMMARY.md) | Summary of the SignalR migration |
...
| [SWAGGER_REMOVAL.md](./backend/signalr/SWAGGER_REMOVAL.md) | Notes on removing Swagger from the SignalR service |
