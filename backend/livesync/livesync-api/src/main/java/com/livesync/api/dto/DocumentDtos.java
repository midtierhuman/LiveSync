...
public final class DocumentDtos {
    ...
    public record DocumentDto(String id, String title, String content, String ownerId, String ownerName, String shareCode,
    ...
    public record ExecuteDocumentRequest(@NotBlank @Pattern(regexp = "^(csharp|cs)$", message = "Only C# execution is currently supported.") String language,
